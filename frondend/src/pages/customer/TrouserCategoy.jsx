    ...
    const fetchProducts = async () => {
      try {
        ...
        if (hasFilters) {
          ...
          params.append('category', 'trousers');
          ...
          response = await api.get(`/user/get-trousers-products?page=${currentPage}`);
        }
        ...
        <Container fluid className="px-4">
          <div className="breadcrumb-navs">
            <div className="breadcrumb-links">
              <Link to="/" style={{ color: '#E2D9C8' }}>Home</Link> / <Link to="/trousers" style={{ color: '#E2D9C8' }}>Trousers</Link>
            </div>
...
export default TrouserCategory;
